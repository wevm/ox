...
Thanks for your interest in contributing to Ox! Please take a moment to review this document **before submitting a pull request.**

If you want to contribute, but aren't sure where to start, you can create a [new discussion](https://github.com/wevm/ox/discussions).
...
```bash
git clone https://github.com/wevm/ox.git --recurse-submodules
```

Or the [GitHub CLI](https://cli.github.com):

```bash
gh repo clone wevm/ox -- --recurse-submodules
```
...
Ox uses [pnpm workspaces](https://pnpm.io/workspaces) to manage multiple projects. You need to install **Node.js v22 or higher** and **pnpm v9.7.0 or higher**.
...
<div>
  ✅ Now you're ready to contribute to Ox!
</div>
