...
RPC conversion with `toRpc` is available for the other five envelope types. Frame RPC
conversion is not available yet; serialize frame transactions for raw submission.
