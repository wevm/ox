...
<Cards>
  <Card
    ...
    description="Type a JSON-RPC transport with a schema and extend it with custom methods."
    to="/guides/rpc/schemas"
  />
  <Card
    icon="lucide:server"
    title="Serve & Handle RPC Requests"
    description="Handle JSON-RPC requests in a server or worker and return typed errors."
    to="/guides/rpc/handling"
  />
  <Card
    icon="lucide:book-open"
    title="Zod Reference"
    description="Browse every schema exported by the ox/zod entrypoint."
    to="/zod"
  />
</Cards>
