...
const name = Ens.normalize('WEVM.eth') // [!code focus]
// @log: 'wevm.eth'
```
...
const node = Ens.namehash('wevm.eth') // [!code focus]
// @log: '0x08c85f2f4059e930c45a6aeff9dcd3bd95dc3c5c1cddef6a0626b31152248560'

const label = Ens.labelhash('wevm') // [!code focus]
...
const coinType = Ens.toCoinType(10n) // [!code focus]
// @log: 2147483658n
