...
- [`WebAuthn`](/api/WebAuthn): P256 and PRF utilities using the [Web Authentication API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Authentication_API). Commonly used in Ethereum Account Abstraction.
...
:::note
We won't cover `WebAuthn` in this guide, please refer to the [WebAuthn Signers](/guides/webauthn) guide instead.
:::
...
:::note
It is important to note that `yParity` (recovery bit) may not be present in _all_ types of ECDSA signatures generated by Ox's Signers. For example, the `WebCryptoP256` & `WebAuthn` Signers do not return a `yParity` value.
:::
...
| [WebAuthn](/api/WebAuthn)           | Utility functions for [NIST P256](https://csrc.nist.gov/csrc/media/events/workshop-on-elliptic-curve-cryptography-standards/documents/papers/session6-adalier-mehmet.pdf) ECDSA cryptography and PRFs using the [Web Authentication API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Authentication_API) |
