...
:::info
Looking for a higher-level abstraction? Check out Viem's [Concurrent Transactions](https://viem.sh/tempo/guides/concurrent-transactions)
guide.
:::
...
<Cards>
  ...
  <Card
    ...
    description="Submit transactions in parallel with independent nonce streams."
