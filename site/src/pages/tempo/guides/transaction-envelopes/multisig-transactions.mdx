...
// 1. Set up the owner keys and genesis config.
const ownerPrivateKeys = [
  Secp256k1.randomPrivateKey(),
  Secp256k1.randomPrivateKey(),
  Secp256k1.randomPrivateKey(),
...
// 5. Attach the genesis config and serialize the transaction.
...
// 5. Attach the approvals and serialize without reinitializing.
