...
does not submit this transaction. For an end-to-end client flow, see Viem's
[Register a Master Address](https://viem.sh/tempo/guides/virtual-addresses/register) guide.
...
<Cards>
  ...
  <Card
    ...
    description="Read the onchain registration requirements."
