...
// Dashed 45° grid — mirrors the landing background in site/src/pages/_root.css.
...
// Palette — mirrors the landing tokens in site/src/pages/_root.css (dark mode).
const colors = {
  bg: '#14110c',
  primary: '#f1ebde',
  secondary: '#a39a85',
...
export default async function handler(request: Request) {
  ...
  const title = url.searchParams.get('title') || 'Ox'
  const description =
    url.searchParams.get('description') || 'Ethereum Standard Library'
