import * as Opcode from 'ox/evm/Opcode'
...
describe('supported', () => {
  test('behavior: every supported name is a known opcode', () => {
    for (const name of Opcode.supported)
      expect(Opcode.codes[name]).toBeDefined()
  })
})
