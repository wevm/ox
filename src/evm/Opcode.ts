...
/**
 * Opcode name to byte value, covering the Prague instruction set.
 *
 * Not every opcode listed here is executable yet — see
 * {@link ox#evm/Opcode.(supported:variable)} for the set the engine implements.
 */
export const codes = {
  STOP: 0x00,
  ADD: 0x01,
...
const names = /*#__PURE__*/ (() => {
  const table: (Name | undefined)[] = new Array(256).fill(undefined)
