...
export type Rpc<pending extends boolean = false> = Compute<
  TransactionEip1559<pending, Hex.Hex, Hex.Hex, TypeRpc>
>

export const type = 'eip1559' as const
export type Type = typeof type

export const typeRpc = '0x2' as const
...
): transaction extends Rpc ? TransactionEip1559<pending> : null {
...
/**
 * Converts an {@link ox#TransactionEip1559.TransactionEip1559} to an {@link ox#TransactionEip1559.Rpc}.
 *
 * @example
 * ```ts twoslash
 * import { TransactionEip1559 } from 'ox'
