 ...
 * `mineSalt` uses `ox`'s built-in JS Keccak path, and the registration helpers
 * reject invalid master addresses up front (zero address, virtual addresses,
 * and TIP-20 token addresses).
 *
 * @example
 * ```ts twoslash
