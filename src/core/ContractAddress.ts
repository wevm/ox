 ...
 *
 * @remarks
 * This is a polymorphic convenience wrapper. Prefer the dedicated
 * {@link ox#ContractAddress.(fromCreate:function)} or
 * {@link ox#ContractAddress.(fromCreate2:function)} entry points: they
 * are clearer at the call site, type-narrow without the union, and skip
 * the runtime `salt` discriminator. The polymorphic shape is retained
 * for backwards compatibility.
 *
 * @example
 * ### CREATE
 *
 * Prefer {@link ox#ContractAddress.(fromCreate:function)}.
 *
 * ```ts twoslash
 ...
 * ### CREATE2
 *
 * Prefer {@link ox#ContractAddress.(fromCreate2:function)}.
 *
 * ```ts twoslash
