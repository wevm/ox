...
describe('fromBlob', () => {
  ...
  test('as: "Bytes" overrides Hex input', () => {
  ...
  test('as: "Hex" overrides Bytes input', () => {
  ...
  test('Hex and Bytes outputs are equivalent', () => {
...
describe('verify', () => {
  test('returns true for a well-formed batch', () => {
  ...
  test('returns false when a cell is tampered', () => {
    const [commitment] = Blobs.toCommitments([blobBytes!], { kzg })
    const { cells, proofs } = BlobCells.fromBlob(blobBytes!, { kzg })
  ...
  test('accepts Hex cells/proofs/commitments', () => {
...
describe('recover', () => {
  test('reconstructs the full set from 64 cells (Bytes)', () => {
    const { cells, proofs } = BlobCells.fromBlob(blobBytes!, { kzg })
  ...
  test('reconstructs the full set from 64 cells (Hex)', () => {
...
describe('toDataColumns', () => {
  test('returns 128 columns, one per column index', () => {
  ...
  test('each column verifies via BlobCells.verify', () => {
