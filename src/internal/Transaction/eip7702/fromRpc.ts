...
/**
 * Converts an {@link ox#TransactionEip7702.Rpc} to an {@link ox#TransactionEip7702.TransactionEip7702}.
 *
 * @example
 * ```ts twoslash
 ...
 * @returns An instantiated {@link ox#TransactionEip7702.TransactionEip7702}.
 */
...
TransactionEip7702_fromRpc.parseError = (error: unknown) =>
  /* v8 ignore next */
  error as TransactionEip7702_fromRpc.ErrorType
