 ...
 */
export function Rlp_toBytes(value: Bytes | Hex.Hex): Rlp_toBytes.ReturnType {
 ...
 */
export function Rlp_toHex(value: Bytes | Hex.Hex): Rlp_toHex.ReturnType {
